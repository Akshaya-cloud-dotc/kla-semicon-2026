...
def main():
    ...
    if not input_dir or not output_dir:
        ...
        print("Usage: python evaluate.py <input_dir> <output_dir>")
        print("Or:    python evaluate.py --input_dir <input_dir> --output_dir <output_dir>")
        return
    ...
    if args.checkpoint:
        ...
        checkpoint_path = os.path.join(script_dir, "finetuned_nafnet.pth")
